...
export function CareersHero() {
  return (
    <section className="from-muted/50 via-background to-background relative overflow-hidden bg-gradient-to-b pt-24 pb-16 lg:pt-32 lg:pb-24">
      <div className="relative z-10 container mx-auto px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-muted-foreground mx-auto max-w-2xl text-lg sm:text-xl">
            Chúng tôi đang tìm kiếm những tài năng đam mê sáng tạo, đổi mới và muốn tạo ra những sản
            phẩm ý nghĩa. Hãy tham gia đội ngũ của chúng tôi!
          </p>
        </div>
      </div>
