...
export function CareersCTA() {
  return (
    <section className="from-primary via-primary/90 to-accent-foreground text-primary-foreground bg-gradient-to-br py-24">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl text-center">
          <div className="bg-primary-foreground/20 mb-6 inline-flex items-center rounded-full px-4 py-1.5 text-sm font-medium backdrop-blur-sm">
            ...
            <span>Tham gia đội ngũ của chúng tôi</span>
          </div>
          ...
          <p className="text-primary-foreground/90 mb-10 text-lg sm:text-xl">
            Chúng tôi luôn tìm kiếm những tài năng xuất sắc. Hãy gửi CV của bạn và chúng tôi sẽ liên
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            >
              <a href="mailto:careers@greetingcard.vn?subject=Ứng tuyển chung">
